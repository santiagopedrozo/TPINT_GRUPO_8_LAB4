...
CREATE TABLE Localidades(
	...
	CONSTRAINT PK_Localidades PRIMARY KEY (IdLocalidad_Loc, IdProvincia_Loc),
    CONSTRAINT FK_LOCALIDADES_PROVINCIAS FOREIGN KEY (IdProvincia_Loc)
		REFERENCES Provincias(IdProvincia_Prov)
);
...
CREATE TABLE Prestamos(
    ...
    CantCuotas_Pr INT NOT NULL DEFAULT 0, -- CUOTAS PAGADAS
...
INSERT INTO Cuentas (DNI_Cuentas, IdTipoCuenta_Cuentas,CBU_Cuentas, Saldo_Cuentas) VALUES
 ...
 (44298830, 1, 11223344556677889900, 10000),
 (44298829, 2, 54768439201928374651, 10000),
 (44298830, 2, 40645090235940530950, 10000),
 (44666777, 1, 32657481920304958676, 10000),
 (44666777, 2, 17283940596877584930, 10000),
 (40334556, 1, 52345678594837261523, 10000),
 (44567566, 2, 63459459234596905030, 10000),
 (41000999, 1, 12341234123412412356, 10000),
 (41000999, 2, 33223344115566778855, 10000),
 (40400500, 1, 53455647765887691234, 10000),
 (44298830, 1, 55664455556644555566, 10000),
 (40900800, 2, 12334523456743512356, 10000),
 (44768845, 1, 21429387239801243867, 10000),
 (44768845, 2, 12328396475328948923, 10000),
 (42456879, 1, 12458234975394859399, 10000);
...
(1, 1, 'Alta de cuenta', 2, 10000.0 ),
(1, 1, 'Alta de cuenta', 3, 10000.0),
(1, 1, 'Alta de cuenta', 4, 10000.0),
(1, 1, 'Alta de cuenta', 5, 10000.0),
(1, 1, 'Alta de cuenta', 6, 10000.0),
(1, 1, 'Alta de cuenta', 7, 10000.0),
(1, 1, 'Alta de cuenta', 8, 10000.0),
(1, 1, 'Alta de cuenta', 9, 10000),
(1, 1, 'Alta de cuenta', 10, 10000),
(1, 1, 'Alta de cuenta', 11, 10000),
(1, 1, 'Alta de cuenta', 12, 10000),
(1, 1, 'Alta de cuenta', 13, 10000),
(1, 1, 'Alta de cuenta', 14, 10000),
(1, 1, 'Alta de cuenta', 15, 10000),
(1, 1, 'Alta de cuenta', 16, 10000);
...
INSERT INTO Prestamos (DNI_Pr,NroCuentaDestino_Pr, ImpSolicitado_Pr, ImpResultante_Pr, PlazoMeses_Pr, ImpPagoAlMes_Pr, Autorizado_Pr, Estado_Pr) VALUES
 (44298830,2,10000,17000,12,1416.66,0,1),
 (44298829,3,20000,34000,12,2833.33,0,1),
 (44298830,4,30000,51000,12,4250.77,0,1),
 (44666777,5,40000,68000,12,5666.66,0,1),
 (44666777,6,50000,85000,12,7083.33,0,1),
 (40334556,7,60000,102000,12,8500.55,0,1),
 (44567566,8,70000,119000,12,9916.66,0,1),
 (41000999,9,80000,136000,12,10461.53,0,1),
 (41000999,10,90000,153000,12,12750.55,0,1),
 (40400500,11,100000,170000,12,14166.66,0,1),
 (44298830,12,110000,187000,12,15583.33,0,1),
 (40900800,13,120000,204000,12, 17000.55,0,1),
 (44768845,14,130000,221000,12,18415.66,0,1),
 (44768845,15,140000,238000,12, 19833.33,0,1),
